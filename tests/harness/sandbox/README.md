...
- `fixtures.py`: shared bounded profile inputs.
- `test_capabilities.py`: platform detection and fail-closed admission.
- `test_environment.py`: redacted bounded secret packets.
